...
public class ReuseBizActivity extends ActionBarActivity implements AdapterView.OnItemClickListener {
    Intent intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reuse_biz);

        // set up the arrayList and adapter that will populate the item ListView
        itemListView = (ListView) findViewById(R.id.listview_reuseBiz);
        ...
        client.get(BASE_URL + pk + "/business/", new JsonHttpResponseHandler() {
            @Override
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_reuse_biz, menu);
        return true;
    }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        intent = new Intent(this, ReuseBizDetailActivity.class);
