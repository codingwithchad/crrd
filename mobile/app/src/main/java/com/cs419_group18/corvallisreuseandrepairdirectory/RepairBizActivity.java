...
public class RepairBizActivity extends ActionBarActivity implements AdapterView.OnItemClickListener {
    Intent intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_repair_biz);

        // set up the arrayList and adapter that will populate the item ListView
        itemListView = (ListView) findViewById(R.id.listview_repairBiz);
        ...
        client.get(BASE_URL + pk + "/repbusiness/", new JsonHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, JSONArray response) {
                ...
                for (int i = 0; i < response.length(); ++i) {
                    try {
                        ...
                        itemList.add(fields.getString("busName"));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_repair_biz, menu);
        return true;
    }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        intent = new Intent(this, RepairBizDetailActivity.class);
